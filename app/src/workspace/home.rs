...
const WARP_HOME_TITLE: &str = "Welcome to PrompTTY on Web";
const WARP_HOME_CONTENT: &str = r#"
Welcome to PrompTTY on Web - your browser-based home for PrompTTY!
Use PrompTTY on Web to:
* Join Shared Sessions
* Create, View, and Edit Warp Drive Objects
* Manage your PrompTTY Settings

PrompTTY on Web can also be used by your teammates and peers who don't have PrompTTY downloaded yet to view your shared sessions, notebooks, and workflows."#;
