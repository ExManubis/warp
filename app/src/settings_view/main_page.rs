            ...
            if ContextFlag::PromptForVersionUpdates.is_enabled() {
                ...
                match autoupdate::get_update_state(app) {
                    ...
                    AutoupdateStage::UnableToUpdateToNewVersion { .. } => (
                        Some(StatusContent {
                            text: "A new version of PrompTTY is available but can't be installed",
                            color: ansi_red,
                        }),
                        Some(CallToActionContent {
                            text: "Update PrompTTY manually",
                    ...
                    AutoupdateStage::UnableToLaunchNewVersion { .. } => (
                        Some(StatusContent {
                            text: "A new version of PrompTTY is installed but can't be launched.",
                            color: ansi_red,
                        }),
                        Some(CallToActionContent {
                            text: "Update PrompTTY manually",
